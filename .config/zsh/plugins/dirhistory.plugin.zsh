...
function dirhistory_zle_dirhistory_back() {
  zle push-line
  BUFFER="dirhistory_back"
  zle accept-line
}

function dirhistory_zle_dirhistory_future() {
  zle push-line
  BUFFER="dirhistory_forward"
  zle accept-line
}
...
for keymap in emacs vicmd viins; do
  # dirhistory_back
  bindkey -M $keymap "^[[1;3D" dirhistory_zle_dirhistory_back

  # dirhistory_future
  bindkey -M $keymap "^[[1;3C" dirhistory_zle_dirhistory_future
...
function dirhistory_zle_dirhistory_up() {
  zle push-line
  BUFFER="dirhistory_up"
  zle accept-line
}

function dirhistory_zle_dirhistory_down() {
  zle push-line
  BUFFER="dirhistory_down"
  zle accept-line
}
...
for keymap in emacs vicmd viins; do
  # dirhistory_up
  bindkey -M $keymap "^[[1;3A" dirhistory_zle_dirhistory_up    # xterm in normal mode

  # dirhistory_down
  bindkey -M $keymap "^[[1;3B" dirhistory_zle_dirhistory_down    # xterm in normal mode
