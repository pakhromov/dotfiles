 ...
 * Sends inject-key/press to Wayfire via $WAYFIRE_SOCKET.
...
int main(int argc, char *argv[])
{
    if (argc < 2)
    {
        ...
        fprintf(stderr, "Example: inject-key KEY_V KEY_LEFTCTRL KEY_LEFTSHIFT\n");
        return 1;
    }
    ...
    int pos = snprintf(msg, sizeof(msg),
        "{\"method\":\"inject-key/press\",\"data\":{\"keycode\":%d", keycode);
